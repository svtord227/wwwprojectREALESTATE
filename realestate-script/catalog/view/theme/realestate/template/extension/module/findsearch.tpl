...
<form method="POST" id="fronm">
	<div class="latest_product_heading post4">
		<h3><?php echo $text_findproperty; ?> <i class="fa fa-search"></i></h3>
	...
	<div class="list-group listing">
		...
		<div class="row form-group">
			...
			<div class="col-sm-12 col-xs-12">	
				<label><?php echo $text_area;?>(<span class="sub"><?php echo $text_SqFt;?></span>)</label>
				<div class="attribute price-filter">
					<input type="hidden" name="route" value="property/category" />
			...
			<div class="col-sm-6 col-xs-12">
				<label><?php echo $text_bedrooms;?></label>
				
				
				<select class="form-control" name="filter_bed_rooms">
					<option value=""><?php echo $text_bed?></option>
					<?php	for ($k =1; $k <=10 ; $k++) { 
						$selected = "";
			...
			<div class="col-sm-6 col-xs-12">
				<label><?php echo $text_bathrooms;?></label>
				<select class="form-control" name="filter_bath_rooms">
					<option value=""><?php echo $text_bath?></option>
					<?php	for ($i =1; $i <=10 ; $i++) { 
						$selected = "";
