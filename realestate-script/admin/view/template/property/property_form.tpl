					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
						...
						<div class="tab-content clearfix">
									...
									<div class="tab-content">
											...
											<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label" for="input-meta_description"><?php echo $entry_meta_descriptions; ?></label>
													<div class="col-sm-10">
								...
								<div class="tab-pane" id="2a">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="input-property_status"><?php echo $entry_property_status; ?></label>
										<div class="col-sm-10">
									...
									<div class="table-responsive">
										<table id="images" class="table table-striped table-bordered table-hover">
											...
											<td class="text-left"><?php echo $entry_images; ?></td>
												<td class="text-left"><?php echo $entry_titles; ?></td>
